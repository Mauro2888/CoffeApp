...
public class AlimentiActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = findViewById(R.id.listView_alimenti);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(AlimentiActivity.this,Contract.URI_CONTENT,projector,Contract.ProdottiDataBase.COLUMN_CATEGORY + " = 'Alimenti'",null,null);
    }
